...
/* Centring on the cap height — not the em box, and not the browser's
   dominant-baseline — is what makes a row of capitals sit optically dead
   centre in its invisible block. The figures below are read off the font
   by tools/extract-glyphs.py; edit the font, not this block. */

/* ── generated by tools/extract-glyphs.py ── */
export const FONT_FAMILY = "Excelsior Insertio LT W04 Rg";
...
export const FONT_STACK = '"Display", "Excelsior Insertio LT W04 Rg", serif';
export const EXPORT_STACK = '"Excelsior Insertio LT W04 Rg", serif';
/* ── end generated ── */
